...
@section('content')
    <div class="container">
        ...
        <form method="POST" class="shadow p-3 mb-5 bg-body rounded"
            action="{{ route('gestion_com.update', [$finds->id]) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="d-flex">
                <div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="message" value="{{ $finds->message }}"id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
